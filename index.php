...
$works = [
    [
        ...
        "dateEnd" => "Текущие время",
        "description" => "Первичная документация, касса, акты сверок, архив",
    ],
    [
        "name" => "Ревизор",
        "dateStart" => "Ноябрь 2018",
        "dateEnd" => "Декабрь 2019",
        "description" => "Выездные проверки, графики проверок, отчет по результатам инвентаризации",
    ],
    [
        "name" => "Логист по транспорту",
        "dateStart" => "Апрель 2015",
        "dateEnd" => "Октябрь 2018",
        "description" => "Составление маршрутного листа, выписка путевых листов, расчёт потраченного ГСМ",
    ],
]
?>
<!DOCTYPE html>
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-twothird">
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right 
          w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
